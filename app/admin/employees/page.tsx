      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-slate-100 h-16 flex items-center justify-between px-4 md:px-8 shrink-0">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-sm md:text-base font-semibold text-slate-800 truncate">Employee Manager</h1>
              <p className="text-[10px] md:text-xs text-slate-400 truncate">Manage all registered employees</p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between px-6 py-4 border-b border-slate-100 gap-4">
                <div className="flex items-center space-x-2">
                  ...
                  <h2 className="text-sm font-bold text-blue-600 uppercase tracking-wider text-nowrap">All Employees</h2>
                  <span className="px-2.5 py-0.5 bg-blue-50 text-blue-600 text-xs font-semibold rounded-full">{employees.length}</span>
                </div>
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-3 sm:space-y-0 sm:space-x-3">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="pl-9 pr-4 py-2 text-xs border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all w-full sm:w-52"
                    />
                  </div>
                  {/* Create button */}
                  <button
                    onClick={() => { setShowCreateModal(true); setFormError(""); setFormName(""); setFormEmail(""); }}
                    className="flex items-center justify-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg transition-colors shadow-sm shadow-blue-200"
                  >
