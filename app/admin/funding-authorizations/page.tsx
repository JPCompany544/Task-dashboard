            ...
            return (
              <Link
                ...
                className={`w-full flex items-center px-3 py-2.5 rounded-lg transition-all duration-150 text-sm ${
                  isActive ? "bg-blue-50 text-blue-600 font-semibold" : "text-slate-500 hover:bg-slate-50 hover:text-slate-800 font-medium"
                }`}
              >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-slate-100 h-16 flex items-center justify-between px-8 shrink-0">
          <div className="flex items-center space-x-3">
            <h1 className="text-base font-semibold text-slate-800">Funding Authorizations</h1>
